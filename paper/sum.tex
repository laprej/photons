...
station such as a Linksys wireless router.  The amount of power in each photon
is based on the number of photons emitted from this antenna;
$\frac{250mW}{\#\;photons}$ is our power per photon.  For our purposes, this
value will be MARK I NEED YOUR NUMBERS.
...
OpenMP \cite{Kumar:2002:IPC:600009} was designed for code bases just like ours: 
pre-written and
